...
public enum ErrorType {
    ...
    BAD_REQUEST_USERNAME_ALREADY_TAKEN(1004, "Kullanıcı adı daha önceden alınmış.", HttpStatus.BAD_REQUEST),
    BAD_REQUEST_EMAIL_ALREADY_TAKEN(1004, "Email daha önceden alınmış.", HttpStatus.BAD_REQUEST),
